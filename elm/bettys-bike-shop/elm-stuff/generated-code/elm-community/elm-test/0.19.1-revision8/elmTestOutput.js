				...
				[
					...
					function (_v1) {
						return A3(
							...
							5.99,
							$author$project$BettysBikeShop$penceToPounds(599));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v2) {
						return A3(
							...
							$elm_explorations$test$Expect$Absolute(0.001),
							0.33,
							$author$project$BettysBikeShop$penceToPounds(33));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/erland/exercism/elm/bettys-bike-shop/tests/Tests.elm']),
		processes: 4,
...
var pipeFilename = "/tmp/elm_test-1446.sock";
var net = require('net'),
