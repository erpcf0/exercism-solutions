...
var $author$project$LuciansLusciousLasagna$preparationTimeInMinutes = function (n) {
	return n * 2;
};
var $author$project$LuciansLusciousLasagna$elapsedTimeInMinutes = F2(
	function (capa, min) {
		return min + $author$project$LuciansLusciousLasagna$preparationTimeInMinutes(capa);
	});
...
var $author$project$LuciansLusciousLasagna$expectedMinutesInOven = 40;
		...
		[
			...
			_List_fromArray(
				[
					...
					'The expected amount of time in the oven is 40 minutes',
					function (_v0) {
						return A2($elm_explorations$test$Expect$equal, 40, $author$project$LuciansLusciousLasagna$expectedMinutesInOven);
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'For 2 layers, the preparation time is 4 minutes',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							4,
							$author$project$LuciansLusciousLasagna$preparationTimeInMinutes(2));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'For 5 layers, the preparation time is 10 minutes',
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							10,
							$author$project$LuciansLusciousLasagna$preparationTimeInMinutes(5));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'For a 3-layers lasagna already in the oven for 10 minutes, you\'ve spent 16 minutes cooking',
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							16,
							A2($author$project$LuciansLusciousLasagna$elapsedTimeInMinutes, 3, 10));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'For a 6-layers lasagna already in the oven for 30 minutes, you\'ve spent 42 minutes cooking',
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							42,
							A2($author$project$LuciansLusciousLasagna$elapsedTimeInMinutes, 6, 30));
					})
				]))
		]));
